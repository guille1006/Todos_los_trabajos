...
sys.path.append("C:/Users/Usuario/Desktop/Ejercicios de uni/Ejercicio 6 Mineria de datos/clase")
...
mosaico_targetbinaria(datos_input['CalifProductor'], varObjBin, 'CalifProductor')

# Veo graficamente el efecto de dos variables cuantitativas sobre la Objetivo binaria
boxplot_targetbinaria(datos_input['Alcohol'], varObjBin, nombre_ejeX='Compra', nombre_ejeY='Alcohol')
boxplot_targetbinaria(datos_input['CloruroSodico'], varObjBin, nombre_ejeX='Compra', nombre_ejeY='CloruroSodico')
...
# Veo graficamente el efecto de dos variables categóricas sobre la Objetivo continua

boxplot_targetbinaria(varObjCont, datos_input['Clasificacion'], nombre_ejeX = 'Clasificacion', nombre_ejeY='Beneficio')
boxplot_targetbinaria(varObjCont, datos_input['Region'], nombre_ejeX = 'Region', nombre_ejeY='Beneficio')

hist_target_categorica(varObjCont, datos_input['Clasificacion'], nombre_ejeX='Beneficio', nombre_ejeY='Clasificacion')
hist_target_categorica(varObjCont, datos_input['Region'], nombre_ejeX='Beneficio', nombre_ejeY='Region')
...
# El coeficiente AcidoCitrico = 4.9865. Por lo que aumentar  una unidad de esta variable 
# produce un aumento esperado de 4.9865 unidades en el beneficio

# El coeficiente Etiqueta_M = -148.0156. Por lo que el beneficio esperado para este 
# tipo de vino se vee reducido en 148.0156 unidades en comparación con la categoria 
# de Etiqueta "B" 
...
# Pruebo un modelo con menos variables, basandome en la importancia de las variables del primer modelo
var_cont3 = []
...
# Por el principio de parsimonia (dado que todos ellos tienen un valor parecido para R^2) 
# elegimos el modelo con menos parametros (modelo3)
len(modelo1['Modelo'].params)
len(modelo2['Modelo'].params)
len(modelo3['Modelo'].params)
