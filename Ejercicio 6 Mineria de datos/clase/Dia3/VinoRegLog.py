...
with open('VinoTodo_bin.pickle', 'rb') as f:
    todo = pickle.load(f)
...
# El coeficiente Densidad = -0.149139. Por lo que su exponencial es 
# e^(-0.149139) = 0.86144. Por lo que la ODD de que se haya comprado un vino de este tipo
# sin añadir una unidad a la variable Densidad es de 1/0.86144 = 1.1608 veces 
# mayor que la ODD de que se haya comprado un vino de este tipo añadiendo esta unidad.

# El coeficiente Etiqueta_M = 0.935122. Por lo que su exponencial es 
# e^(0.935122) = 2.5475. Por lo que la ODD de que se haya comprado un vino de este tipo
# si la categoría de Etiqueta es "M" es de 2.5475 veces 
# mayor que la ODD de que se haya comprado un vino de este tipo si la categoría de Etiqueta es "B".
...
# Fijandome en la significancia de las variables, el modelo con las variables mas significativas queda
var_cont2 = ['pH', 'Azucar']
...
# Fijandome en la importancia de las variables del modelo inicial,
# el modelo con las variables mas importantes queda
var_cont3 = []
...
var_cont4 = ['Densidad', 'Acidez', 'CloruroSodico']
var_categ4 = ['CalifProductor', 'Clasificacion', 'prop_missings']
...
var_cont5 = var_cont4
var_categ5 = var_categ4
var_interac5 = [('Clasificacion', 'prop_missings')]
...
x_test_modelo5 = crear_data_modelo(x_test, var_cont5, var_categ5, var_interac5)
...
var_cont6 = var_cont4
var_categ6 = var_categ4
var_interac6 = [('prop_missings', 'CalifProductor'), ('Clasificacion', 'CalifProductor')]
...
# Consideramos por su reducido número de parámetros (a costancia de AUC)
# que el modelo3 es el mejor.

print("Resultados de los modelos:")
print("Modelo 1 - AUC:", AUC1, " | Longitud del modelo:", len(modeloInicial['Modelo'].coef_[0]))
print("Modelo 2 - AUC:", AUC2, " | Longitud del modelo:", len(modelo2['Modelo'].coef_[0]))
print("Modelo 3 - AUC:", AUC3, " | Longitud del modelo:", len(modelo3['Modelo'].coef_[0]))
print("Modelo 4 - AUC:", AUC4, " | Longitud del modelo:", len(modelo4['Modelo'].coef_[0]))
print("Modelo 5 - AUC:", AUC5, " | Longitud del modelo:", len(modelo5['Modelo'].coef_[0]))
print("Modelo 6 - AUC:", AUC6, " | Longitud del modelo:", len(modelo6['Modelo'].coef_[0]))
...
for rep in range(20):
    ...
    results_rep = pd.DataFrame({
        ...
        , 'Resample': ['Rep' + str((rep + 1))]*5*6  # Etiqueta de repetición (5 repeticiones 5 modelos)
        , 'Modelo': [1]*5 + [2]*5 + [3]*5 + [4]*5 + [5]*5 + [6]*5# Etiqueta de modelo (5 modelos 5 repeticiones)
    })
...
# Seguimos considerando al modelo3, como el mejor.
